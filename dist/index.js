...
var ProtractorRunner = require('protractor/built/runner').Runner;
var ParallelInstanceHelper = /** @class */ (function () {
    function ParallelInstanceHelper() {
    }
    /**
     ...
     */
    ParallelInstanceHelper.createNewBrowser = function (configurationFile, waitForAngularEnabled) {
        if (waitForAngularEnabled === void 0) { waitForAngularEnabled = false; }
        return __awaiter(this, void 0, void 0, function () {
            var ptorConfig, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ptorConfig = new ProtractorConfigParser().config_;
                        // append config properties
                        Object.entries(configurationFile).forEach(function (_a) {
                            var key = _a[0], value = _a[1];
                            return ptorConfig[key] = value;
                        });
                        // local preference
